...
const WorkspacesWidget = () => Workspaces({
        ...
        box: 'background: black; min-width: 10px; min-height: 38px; margin-top: 6px; margin-left: 6px; padding-left: 4px; padding-right: 4px; border-radius: 6px;'
    },
    [
        {
            "id": 1,
...
const CenterLayout = () => Widget.Box({
    ...
    children: [
        Widget.Box({
            css: 'background: black; min-width: 10px; min-height: 38px; margin-top: 6px; margin-right: 6px; padding-left: 10px; padding-right: 10px; border-radius: 6px;',
            child: ActiveIcon('font-family: FiraCode; font-size: 20px;', { 'Code': 'Visual Studio Code' }, 'application-x-executable')
        }),
        Widget.Box({
            css: 'background: black; min-width: 10px; min-height: 38px; margin-top: 6px; padding-left: 12px; padding-right: 12px; border-radius: 6px;',
...
const RightLayout = () => Widget.Box({
    ...
    children: [
        Widget.Box({ hexpand: true }),
        Widget.Box({
            css: 'background: black; min-width: 10px; min-height: 38px; margin-top: 6px; margin-right: 6px; padding-left: 12px; padding-right: 12px; border-radius: 6px;',
            child: PowerProfiles(
        ...
        SystemTray(
            'background: black; min-width: 10px; min-height: 38px; margin-top: 6px; margin-right: 6px; padding-left: 4px; padding-right: 4px; border-radius: 6px;',
        ...
        QuickActions(
            ...
            'background: black; min-width: 10px; min-height: 38px; margin-top: 6px; margin-right: 6px; padding-left: 10px; padding-right: 4px; border-radius: 6px;',
