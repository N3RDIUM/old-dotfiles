...
const WorkspacesWidget = () => Workspaces({
        ...
        box: 'background: rgba(46, 52, 64, 0.75); min-width: 10px; min-height: 40px; margin-top: 8px; margin-left: 8px; padding-left: 6px; padding-right: 4px; border-radius: 6px;'
    },
    [
        {
            "id": 1,
...
const CenterLayout = () => Widget.Box({
    ...
    children: [
        Widget.Box({
			css: 'background: rgba(46, 52, 64, 0.75); min-width: 10px; min-height: 40px; margin-top: 8px; margin-right: 8px; padding-left: 10px; padding-right: 10px; border-radius: 8px;',
            child: ActiveIcon('font-family: FiraCode; font-size: 20px;', { 'Code': 'Visual Studio Code' }, 'application-x-executable')
        }),
        Widget.Box({
			css: 'background: rgba(46, 52, 64, 0.75); min-width: 10px; min-height: 40px; margin-top: 8px; padding-left: 12px; padding-right: 12px; border-radius: 8px;',
...
const RightLayout = () => Widget.Box({
    ...
    children: [
        Widget.Box({ hexpand: true }),
        Widget.Box({
			css: 'background: rgba(46, 52, 64, 0.75); min-width: 10px; min-height: 40px; margin-top: 8px; margin-right: 8px; padding-left: 12px; padding-right: 12px; border-radius: 8px;',
            child: PowerProfiles(
        ...
        SystemTray(
            'background: rgba(46, 52, 64, 0.75); min-width: 10px; min-height: 38px; margin-top: 8px; margin-right: 8px; padding-left: 4px; padding-right: 4px; border-radius: 8px;',
        ...
        QuickActions(
            ...
            'background: rgba(46, 52, 64, 0.75); min-width: 10px; min-height: 38px; margin-top: 8px; margin-right: 8px; padding-left: 10px; padding-right: 4px; border-radius: 8px;',
